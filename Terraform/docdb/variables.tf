...
variable "tunnelling_sg" {
  type    = string
  default = "tunnelling_sg"
}
...
variable "subnet_group_docdb" {
  type    = string
  default = "docdb_subnet_group"
}
